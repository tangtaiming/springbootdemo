...
<head>
    ...
    <#assign static="http://127.0.0.1:8080/static" />
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <#if menuList??>
                    <#list menuList as menu>
                        <#if menu.chindMenus??>
                            <li class="treeview">
                                <a href="${menu.url!''}"><i class="${menu.icon!'fa fa-link'}"></i> <span>${menu.name!''}</span>
                                    <span class="pull-right-container">
                                        <i class="fa fa-angle-left pull-right"></i>
                                    </span>
                                </a>
                                <ul class="treeview-menu">
                                    <#list menu.chindMenus as cmenu>
                                        <li><a href="${cmenu.url!''}"><i class="${menu.icon!'fa fa-link'}"></i> <span>${cmenu.name!''}</span></a></li>
                                    </#list>
                                </ul>
                            </li>
                            <#else>
                            <li><a href="${menu.url!''}"><i class="${menu.icon!'fa fa-link'}></i> <span>${menu.name!''}</span></a></li>
                        </#if>
                    </#list>
                </#if>
            </ul>
